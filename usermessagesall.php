...
<body>
    <br>
    <a href="#" class="filter-message" id="filter-allmessage">Все заявки</a>
    <a href="#" class="filter-message" id="filter-newmessage">Новые заявки</a>
    <a href="#" class="filter-message" id="filter-solvemessage">Решенные заявки</a>
    <a href="#" class="filter-message" id="filter-escmessage">Отклоненные заявки</a>
    <br>
</body>
<?
    session_start();
